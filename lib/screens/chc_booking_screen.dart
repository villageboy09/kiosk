...
class CHCTheme {
  ...
  static const slotBooked = Color(0xFFFFA000); // Amber for slot booked/pending
}
...
class _CHCBookingScreenState extends State<CHCBookingScreen> {
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.error_outline,
                    size: 48, color: CHCTheme.errorText),
              ),
              ...
              Text(
                message ??
                    'క్షమించండి, ఈ తేదీలో స్లాట్లు అన్నీ బుక్ అయిపోయాయి.\n(Fully Booked)',
                style: GoogleFonts.notoSansTelugu(
                  fontSize: 14,
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.check,
                        size: 48, color: CHCTheme.primary),
                  ),
                  const SizedBox(height: 20),
                  Text(
  ...
  Widget _buildHeader(dynamic currentUser) {
    return Container(
      padding: EdgeInsets.fromLTRB(
          20, MediaQuery.of(context).padding.top + 16, 20, 25),
      decoration: const BoxDecoration(
                  ...
                  children: [
                    if (_state.isMember)
                      const Icon(Icons.star,
                          color: CHCTheme.memberBadge, size: 16),
                    const SizedBox(width: 4),
                    Text(
                      _state.isMember
                          ? 'సభ్యులు (Member)'
                          : 'సభ్యత్వం లేదు (Non-Member)',
                      style: GoogleFonts.notoSansTelugu(
                        fontSize: 12,
                        color: Colors.white,
                        fontWeight: FontWeight.w600,
    ...
    return Column(
      children: [
        ...
        if (_state.equipment != null &&
            _state.equipment!.billingType == 'Variable')
          Container(
            width: double.infinity,
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    ...
                    style:
                        isFullyBooked ? BorderStyle.solid : BorderStyle.solid,
                  ),
                ),
                child: Center(
                  child: Text(
  ...
  Widget _buildSummaryPanel(String locale) {
    final equipmentName =
        _state.equipment?.getDisplayName(locale) ?? 'ఎంచుకోండి';
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 52,
                    child: FilledButton(
                      onPressed: _state.isValid && !_isSubmitting
                          ? _submitBooking
                          : null,
                      style: FilledButton.styleFrom(
                        backgroundColor: CHCTheme.primary,
